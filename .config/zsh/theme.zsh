# only load theme if using alacritty
...
# Generated by Powerlevel10k configuration wizard on 2021-02-20 at 15:55 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=31
  ...
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_BACKGROUND=75
  ...
  typeset -g POWERLEVEL9K_NODE_VERSION_BACKGROUND=34
